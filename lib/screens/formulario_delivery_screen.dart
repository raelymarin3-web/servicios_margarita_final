...
class FormularioDeliveryScreen extends StatefulWidget {
  const FormularioDeliveryScreen({super.key});

  @override
  State<FormularioDeliveryScreen> createState() => _FormularioDeliveryScreenState();
}

class _FormularioDeliveryScreenState extends State<FormularioDeliveryScreen> {
  final TextEditingController _nombreController = TextEditingController();
  final TextEditingController _telefonoController = TextEditingController();
  final TextEditingController _localidadController = TextEditingController();
  final TextEditingController _zonasController = TextEditingController();
  ...
  void _guardar() {
    if (_nombreController.text.isEmpty ||
        ...
        _zonasController.text.isEmpty ||
        _vehiculoController.text.isEmpty) {
    ...
    _mostrarMensaje('✅ Delivery registrado exitosamente');
    _limpiarCampos();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('📦 Registrar Delivery'),
        ...
        child: Column(
          ...
          children: [
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        ...
                        style: TextStyle(
                          color: _fotoPerfil != null ? Colors.green : (isDark ? Colors.grey[400] : Colors.grey[600]),
            ...
            _buildTextField(
              ...
              hintText: 'Ej: Porlamar, Pampatar, El Valle',
            ...
            _buildTextField(
              ...
              hintText: 'Ej: Moto, Bicicleta, Carro',
